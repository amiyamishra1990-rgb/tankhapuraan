...
const products = [
  ...
  { id: 'p3', adhyaya: 'Adhyaya III — Vetan Sanhita', icon: 'fa-gavel', name: 'Naya Wage Code Jaanch', hindi: 'नया वेतन संहिता जाँच', tagline: 'Naye Labour Codes ne tumhari salary badal di? 50% wage rule compliance, chhupa hua take-home impact, aur gratuity growth check karo.', price: '₹99', period: '/report', status: 'live', statusClass: 'status-live' },
  { id: 'p4', adhyaya: 'Adhyaya IV — Samvaad', icon: 'fa-handshake', name: 'Hike Mantra', hindi: 'वेतन वृद्धि मंत्र', tagline: 'Appraisal se pehle ka hathiyar: take-home reality check, transparent anchor math, aur ready-to-say negotiation script.', price: '₹151', period: '/report', status: 'live', statusClass: 'status-live' },
