...
const products = [
  ...
  { id: 'p2', adhyaya: 'Adhyaya II — Vetan', icon: 'fa-file-invoice-dollar', name: 'Slip Pariksha', hindi: 'वेतन पर्ची परीक्षा', tagline: 'Tumhari salary slip sahi hai ya galat? Har line decode, Slip Health Score, aur restructure letter.', price: '₹99', period: '/report', status: 'building', statusClass: 'status-building' },
