...
// v7: New dashboard, 8 products, Name+Email modal, Bundle section, 22 languages
...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .hero {
    background: ${C.ink};
    background-image:
      radial-gradient(ellipse at 20% 50%, rgba(124,19,22,0.35) 0%, transparent 60%),
      radial-gradient(ellipse at 80% 50%, rgba(124,19,22,0.2) 0%, transparent 60%);
  ...
  .hero-devanagari::before, .hero-devanagari::after {
    content: '';
    width: 36px;
    height: 1px;
    background: ${C.gold};
  ...
  .btn-outline {
    ...
    border: 1.5px solid rgba(245,237,216,0.25);
    color: rgba(245,237,216,0.75);
    font-family: 'EB Garamond', serif;
    font-size: 17px;
    padding: 13px 28px;
  ...
  .trust-bar {
    ...
    border-top: 1px solid rgba(124,19,22,0.15);
    border-bottom: 1px solid rgba(124,19,22,0.15);
    padding: 14px 24px;
    display: flex;
    align-items: center;
    justify-content: center;
  ...
  .calc-section {
    background: ${C.paper};
    padding: 0 20px 56px;
    border-top: 1px solid ${C.paperDeep};
    border-bottom: 1px solid ${C.paperDeep};
  }
  ...
  .regime-card.winner {
    background: linear-gradient(135deg, rgba(124,19,22,0.07), rgba(124,19,22,0.03));
  ...
  .modal-card {
    background: ${C.cream};
    border: 1.5px solid ${C.gold};
    border-top: 4px solid ${C.sindoor};
    padding: 36px 32px;
    max-width: 420px;
    width: 100%;
    position: relative;
  ...
  .product-card:hover {
    box-shadow: 0 8px 32px rgba(124,19,22,0.1);
  ...
  .footer {
    ...
    text-align: center;
    border-top: 2px solid ${C.sindoor};
  }
  ...
  const handleModalSubmit = () => {
    ...
    const options = {
      ...
      handler: function(response) {
        alert("Payment successful! Your TankhaPuraan Patrika will be emailed to " + userEmail + " within 10 minutes. Payment ID: " + response.razorpay_payment_id);
      },
      prefill: {
        name: userName,
        email: userEmail,
      ...
      <div className={`app ${rtl ? "rtl" : ""}`}>
        ...
        <section className="hero">
          ...
          <h1 className="hero-title">
            Har Salaried Indian Ka<br />
            <em>Digital Vakeel, CA & Advisor</em>
          </h1>
          <p className="hero-tagline">
            Jo tumhara HR nahi batata. Jo tumhara CA chhupaata hai.<br />
            Woh sirf TankhaPuraan batata hai.
          </p>
        ...
        <section className="calc-section" id="calculator">
          ...
          <div className="calc-card">
            <div className="form-group">
              ...
              <input
                type="number"
                placeholder="Apna annual CTC daalo"
                value={income}
            ...
            {result && (
              <div className="verdict">
                ...
                {result.saving > 0 && (
                  <div className="savings-banner">
                    ...
                    <div className="savings-label">
                      Aapki Bachat | {inr(result.saving / 12)} maas priti bachat
                    </div>
                  </div>
                )}
                ...
                <p className="disclaimer">
                  ⚠ Yeh calculation sirf information ke liye hai. Final decision ke liye CA se milo. TankhaPuraan kisi bhi financial loss ke liye zimmedaar nahi.
                </p>
              </div>
            )}
          </div>
          ...
          <div className="bundle-card">
            ...
            <div className="bundle-chips">
              {BUNDLE_PRODUCTS.map(p => (
                <span className="bundle-chip" key={p.id}>{p.name} {p.price}</span>
              ))}
            </div>
            ...
            <a href="#calculator" className="btn-gold" style={{fontSize: "17px", padding: "15px 36px"}}>
        ...
        <section className="how-section" id="how">
          ...
          <div className="steps">
            <div className="step">
              <div className="step-num">१</div>
              <div className="step-title">Apna Data Daalo</div>
              <div className="step-desc">Salary, deductions, aur situation ke hisaab se inputs fill karo</div>
            </div>
            <div className="step">
              <div className="step-num">२</div>
              <div className="step-title">Securely Pay Karo</div>
              <div className="step-desc">Razorpay se UPI, card, net banking — sab accepted</div>
            </div>
            <div className="step">
              <div className="step-num">३</div>
              <div className="step-title">Patrika Pao</div>
              <div className="step-desc">10 minute mein personalized report tumhare email par</div>
            </div>
          </div>
        </section>
          ...
          <div className="modal-overlay" onClick={e => { if (e.target.className === "modal-overlay") setShowModal(false); }}>
            <div className="modal-card">
              ...
              <div className="modal-field">
                ...
                <input
                  type="text"
                  placeholder="e.g. Amiya Kumar Mishra"
                  value={userName}
              ...
              <div className="modal-field">
                ...
                <input
                  type="email"
                  placeholder="e.g. amiya@example.com"
                  value={userEmail}
              ...
              <button
                ...
                style={{ opacity: (!userName.trim() || !userEmail.trim()) ? 0.6 : 1 }}
              >
                Aage Badho — ₹199 Pay Karo →
              </button>
